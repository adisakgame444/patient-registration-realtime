...
//     ? "border-red-400 ring-4 ring-red-500/15 bg-white" // 🔴 ถ้าผิด: แดงเท่านั้น ห้ามมีเทา ห้ามมี Hover
//     : isOpen
//       ? "border-indigo-500 ring-4 ring-indigo-500/15 bg-white" // 🟣 ถ้ากดเปิด: ม่วง (Active)
//       : "border-slate-200 bg-slate-50/50 hover:border-slate-300"; // ⚪ ถ้าปกติ: ถึงจะยอมให้มีขอบเทาและ Hover ได้
...
//         className={`relative w-full pl-10 pr-10 p-3.5 border rounded-xl cursor-pointer flex items-center justify-between transition-all select-none ${borderStyles}`}
//       >
//         <div
